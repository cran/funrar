...
In their article, Violle et al. (in revision) introduced 4 indices to compute functional rarity indices. `funrar` package enables ecologists to compute these on any dataset.
