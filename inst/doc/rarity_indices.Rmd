...
In their article, Violle et al. (accepted) introduced 4 indices to compute functional rarity indices. `funrar` package enables ecologists to compute these on any dataset.
